...
def Generar_PDF(nombre_archivo, nombre_csv, fecha, total_ventasDinero, total_productosVendidos, promedio):
    ...
    try:
        ...
        nombre_sin_extension = os.path.splitext(os.path.basename(nombre_csv))[0]
           
        ruta_img_barras = f"static/uploads/IMG_Graficas/grafica_Barras_{nombre_sin_extension}.png"
        ruta_img_lineas = f"static/uploads/IMG_Graficas/grafica_Lineas_{nombre_sin_extension}.png"
        ruta_img_pastel = f"static/uploads/IMG_Graficas/grafica_Pastel_{nombre_sin_extension}.png"
